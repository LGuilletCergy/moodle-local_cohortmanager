...
//}
//
//mail('s.ingenierie.logicielle@ml.u-cergy.fr', 'Cohortes de groupes plein traitées',
//        "\nLa partie du script gérant les cohortes de groupe pleins vient de s'achever à ".date("d/m/Y à G:i")."");
//
...
//}
//
//mail('s.ingenierie.logicielle@ml.u-cergy.fr', 'Cohortes de groupes vides traitées',
//        "\nLa partie du script gérant les cohortes de groupe vides vient de s'achever à ".date("d/m/Y à G:i")."");
//
...
//}
//
//mail('s.ingenierie.logicielle@ml.u-cergy.fr', 'Cohortes de VETs et de composantes traitées',
//        "\nLa partie du script gérant les cohortes de VETs remplies et de composantes vient de s'achever à"
//        . " ".date("d/m/Y à G:i")."");
//
...
//}
//
//mail('s.ingenierie.logicielle@ml.u-cergy.fr', 'Cohortes Tous Etudiants traitée',
//        "\nLa partie du script gérant la cohorte de tous les étudiants vient de s'achever à ".date("d/m/Y à G:i")."");
//
...
//}
//
//mail('s.ingenierie.logicielle@ml.u-cergy.fr', 'Cohortes de Tous Enseignants traitée',
//        "\nLa partie du script gérant la cohorte de tous les enseignants vient de s'achever à ".date("d/m/Y à G:i")."");
//
...
//}
//
//mail('s.ingenierie.logicielle@ml.u-cergy.fr', 'Cohortes de Tous Personnels traitées',
//        "\nLa partie du script gérant la cohorte de tout le personnel vient de s'achever à ".date("d/m/Y à G:i")."");
//
...
//}
//
//mail('s.ingenierie.logicielle@ml.u-cergy.fr', 'Cohortes des faux vacataires traitées',
//        "\nLa partie du script gérant les cohortes des faux vacataires vient de s'achever à ".date("d/m/Y à G:i")."");
//
...
//}
//
//mail('s.ingenierie.logicielle@ml.u-cergy.fr', 'Cohortes des profs de composante traitées',
//        "\nLa partie du script gérant les cohortes des profs de composante vient de s'achever à"
//        . " ".date("d/m/Y à G:i")."");
//
...
//}
//
//mail('s.ingenierie.logicielle@ml.u-cergy.fr', 'Cohortes de niveaux traitées',
//        "\nLa partie du script gérant les cohortes de niveaux vient de s'achever à ".date("d/m/Y à G:i")."");

// Cohortes de VET EISTI, regarder et modifier
...
$listcohortsvetseistidb = $DB->get_records_sql($sqllistcohortsvets);

$listexistenceeisti = array();

foreach ($listcohortsvetseistidb as $cohortvetdb) {
    ...
    foreach ($listmembersdb as $memberdb) {
        ...
        $listexistenceeisti[] = $tempexistence;
    }
}
                    ...
                    if ($inscription->getAttribute('CodeCycle') == 'c0_bachelor01' ||
                        ...
                        if ($DB->record_exists('course_categories', array('idnumber' => $cohortcode))) {
                            ...
                            if ($DB->record_exists('local_cohortmanager_info',
                                ...
                                $cohortinfo->codeelp = 0;
                                $cohortinfo->timesynced = $timesync;
                                $cohortinfo->typecohort = "veteisti";
                            ...
                            if (!$DB->record_exists('cohort_members',
                                ...
                                foreach ($listexistenceeisti as $tempexistence) {
